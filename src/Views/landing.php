...
<section class="hero">
    <div class="hero-content">
        ...
        <div class="hero-actions">
            <a class="button" href="/login">Access the platform</a>
...
<section id="activation" class="section">
    <div class="section-heading">
        ...
        <a class="button secondary" href="/login">Start configuration</a>
    </div>
    <div class="grid">
        <article class="card">
...
<section class="cta">
    ...
    <a class="button" href="/login">Launch the workspace</a>
</section>
